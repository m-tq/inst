 ...
 * 指定安装目标os镜像：debian是原生方式安装的纯净debian,dummy是空目标仅供调试模式用,自定义镜像是dd方式安装的raw系统硬盘格式经过gzip/xz打包后托管的http/https地址，或者qcow2格式的cloudimage托管的http/https地址,[《这里收集了一些第三方dd镜像仓库》](https://minlearn.org/inst/instrepos/)  
